...
<mapper namespace="${basePackage}.${daoPackage}.${entityName}Mapper" >
    ...
    <sql id="insert${entityName}" parameterType="${basePackage}.${entityPackage}.${entityName}">
    ...
    <#list keys as key>
    <sql id="find${entityName}By${key?lower_case?cap_first}" parameterType="${basePackage}.${entityPackage}.${entityName}" 
    ...
    <sql id="update${entityName}By${key?lower_case?cap_first}" parameterType="${basePackage}.${entityPackage}.${entityName}">
    ...
    <sql id="delete${entityName}By${key?lower_case?cap_first}" parameterType="${basePackage}.${entityPackage}.${entityName}">
